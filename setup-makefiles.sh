...
(cat << EOF) | sed s/__DEVICE__/$DEVICE/g | sed s/__VENDOR__/$VENDOR/g > $MAKEFILE
# Copyright (C) 2013 The CyanogenMod Project
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
...
PRODUCT_COPY_FILES += \\
        vendor/__VENDOR__/__DEVICE__/proprietary/sbin/mfgsrv:root/sbin/mfgsrv \\
        vendor/__VENDOR__/__DEVICE__/proprietary/sbin/sfc:root/sbin/sfc \\
        vendor/__VENDOR__/__DEVICE__/proprietary/sbin/tpd:root/sbin/tpd
