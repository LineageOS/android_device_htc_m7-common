...
DEVICE_PATH_M7COMMON := device/htc/m7-common

TARGET_SPECIFIC_HEADER_PATH := $(DEVICE_PATH_M7COMMON)/include
...
BOARD_AUDIO_AMPLIFIER := $(DEVICE_PATH_M7COMMON)/libaudioamp
BOARD_HAVE_HTC_CSDCLIENT := true

# Bluetooth
BOARD_BLUEDROID_VENDOR_CONF := $(DEVICE_PATH_M7COMMON)/bluetooth/libbt_vndcfg.txt
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := $(DEVICE_PATH_M7COMMON)/bluetooth
...
# CMHW
BOARD_HARDWARE_CLASS := $(DEVICE_PATH_M7COMMON)/cmhw
...
TARGET_RECOVERY_DEVICE_DIRS += $(DEVICE_PATH_M7COMMON)
TARGET_RECOVERY_FSTAB := $(DEVICE_PATH_M7COMMON)/rootdir/etc/fstab.qcom
