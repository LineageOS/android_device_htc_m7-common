...
public class ButtonBacklightSwitch implements OnPreferenceChangeListener {
    ...
    public static String getValue(Context context) {
        ...
        return sharedPrefs.getString(TouchscreenFragmentActivity.KEY_BUTTONBACKLIGHT_SWITCH, value);
    }

    /**
     * Restore ButtonBacklight setting from SharedPreferences. (Write to kernel.)
